...
public class Constants {
    ...
    public static final String CONTAINER_NAME_PLAYERBOARDS = "Playerboards";
    ...
    public static final String OPERATION_NAME_JOIN_GROUPS = "[MODEL] IslandGroup constructor";

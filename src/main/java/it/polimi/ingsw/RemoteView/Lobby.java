...
import it.polimi.ingsw.RemoteView.Messages.Events.ClientConnected;
import it.polimi.ingsw.RemoteView.Messages.Events.ClientDisconnected;
...
public class Lobby {
        ...
        synchronized (this.players) {
            ...
            if (this.players.contains(nick)) {
                ...
                if (!this.playerEventSources.containsKey(nick)) {
                    notifyPlayers(new ClientConnected(nick));
    ...
    protected void removePlayerHandler(String nick) {
        synchronized (this.players) {
            ...
            notifyPlayers(new ClientDisconnected(nick));
        }
    }
